...
public class ForwardServerClientThread extends Thread
{
     ...
     */
    public ForwardServerClientThread(Socket aClientSocket, String serverhost, int serverport,SecretKey  secretKey, IvParameterSpec IV)
    {
     ...
     * A server socket is created later by run() method.
     */
    public ForwardServerClientThread(ServerSocket listensocket, String serverhost, int serverport,SecretKey  secretKey, IvParameterSpec IV) throws IOException
    {
    ...
    public void run()
    {
        try {
           ...
           // Start forwarding of socket data between server and client
            ForwardThread clientForward = new ForwardThread(this, clientIn, serverOut,a,0,this.secretKey,this.IV);
            ForwardThread serverForward = new ForwardThread(this, serverIn, clientOut,a,1,this.secretKey,this.IV);
